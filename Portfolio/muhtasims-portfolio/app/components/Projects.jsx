              ...
              <div className={`order-1 ${index % 2 === 1 ? 'lg:order-2' : 'lg:order-1'}`}>
                ...
                >
                  ...
                  <div className='flex items-center gap-4'>
                    <div className='text-6xl md:text-7xl font-bold text-[#E48A57]/20'>
                  ...
                  {/* Project Title */}
                  <h3 className='text-3xl md:text-4xl font-bold text-white group-hover:text-[#E48A57] transition-colors duration-300'>
                    {project.title}
                  </h3>
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className='inline-flex items-center gap-3 px-6 py-3 bg-[#E48A57] text-black font-semibold rounded-xl hover:bg-[#DBAF6E] transition-all duration-300 shadow-lg hover:shadow-xl'
                  >
